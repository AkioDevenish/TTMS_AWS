<template>
    <Card1 colClass="col-xl-3 col-md-6 proorder-xl-2 proorder-md-2" dropdown="true" headerTitle="true"
        title="Opening of leaflets" cardhaderClass="card-no-border pb-0" cardbodyClass="pb-0 opening-box">
