<template>
    <div>
        <div class="row g-2">
            <div class="col-xl-3 col-md-6 proorder-xl-3 proorder-md-3" v-for="(item, index) in ott_hydromet_data" :key="index">
...
import { ott_hydromet_data } from "@/core/data/dashboards"
