<template>
    <Card1 colClass="col-xl-12 col-md-12 proorder-md-1" headerTitle="true" title="OTT-Hydromet Monitor "
...
import { ott_hydromet_monitor } from "@/core/data/dashboards"
...
onMounted(() => {
    allData.value = ott_hydromet_monitor;
})
</script>