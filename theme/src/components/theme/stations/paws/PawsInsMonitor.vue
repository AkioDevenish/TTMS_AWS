<template>
    <Card1 colClass="col-xl-12 col-md-12 proorder-md-1" headerTitle="true" title="3DPaws Monitor "
...
import { paws_monitor } from "@/core/data/dashboards"
