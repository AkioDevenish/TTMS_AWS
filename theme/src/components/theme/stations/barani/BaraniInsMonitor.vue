<template>
    <Card1 colClass="col-xl-12 col-md-12 proorder-xl-1 proorder-md-1" headerTitle="true" title="Barani Monitor"
...
import { baranimonitor } from "@/core/data/dashboards"
