...
# Set timezone to Trinidad (UTC-4)
...
CELERY_TIMEZONE = 'America/Port_of_Spain'
...
# Add JWT settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=15),  # Shorter access token for better security
...
SITE_NAME = os.getenv("SITE_NAME", "TTMSAWS")
