    ...
    <div class="card hovercard text-center">
      ...
      <div class="info">
        <div class="row align-items-center ">
          <div class="col-sm-6 col-lg-4 order-sm-1 order-xl-1">
            <div class="row">
              <div class="col-md-6">
                <div class="ttl-info text-start mb-0">
          ...
          <div class="col-sm-12 col-lg-4 order-sm-0 order-xl-0">
            <div class="user-designation text-start mb-0">
              <div class="title">
                <a href="#">{{ fullName }}</a>
              </div>
...
/* set --bs-gutter-y to 1.5rem for row gap */
.row {
  --bs-gutter-y: 1.5rem;
}
